...
export default function WeatherDisplay({weatherData, iconSize = {width: 50, height:50}}) {

    const getWeatherById = (data) => {
        const id = data.weather_id;
        
        //weather_idによって天気を判定
        if (id === 800) return { text: '晴れ/Clear', icon: 'clear' };
    ...
    return (
        <div className={styles.container}>
                <Image
                    src={`/svg/weather/${weather.icon}.svg`}
